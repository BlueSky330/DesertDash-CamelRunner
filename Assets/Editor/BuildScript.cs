...
/// iOS: -executeMethod BuildScript.PerformIOSBuild
/// Android: -executeMethod BuildScript.PerformAndroidBuild
/// </summary>
public static class BuildScript
{
    ...
    // iOS Build — called by Codemagic: -executeMethod BuildScript.PerformIOSBuild
    public static void PerformIOSBuild()
    {
        ...
        // Output path: Codemagic expects Xcode project at CM_BUILD_DIR/ios
        string outputPath = "ios";
    ...
    // Android Build — called by Unity Build Agent: -executeMethod BuildScript.PerformAndroidBuild
    ...
    private static string[] GetScenes()
    {
        ...
        if (scenes.Length == 0)
        {
            scenes = AssetDatabase.FindAssets("t:Scene", new[] { "Assets" })
                ...
                .ToArray();
            Debug.LogWarning(
                $"[BuildScript] No enabled scenes in BuildSettings - using all {scenes.Length} scenes.");
        }
